...
namespace Vlingo.Symbio
{
    ...
    public interface IEntryAdapter<TSource, TEntry> where TEntry : class
    {
        /// <summary>
    ...
    public abstract class EntryAdapterBase<TSource, TEntry> : IEntryAdapter<TSource, TEntry> where TEntry : class
    {
